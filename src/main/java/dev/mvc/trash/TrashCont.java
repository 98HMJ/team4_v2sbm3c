...
public class TrashCont {
  ...
  public String create(TrashVO trashVO) {
    return "trash/create";
  }
  ...
  public String trash_list_all(Model model) {
  ...
  public String trash_read(Model model, int trashno) {
  ...
  public String trash_list_search(Model model, @RequestParam(name = "word", defaultValue = "") String word) {
 ...
 // -------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------
    // 삭제할 파일 정보를 읽어옴.
    TrashVO contentsVO_read = trashProc.trash_read(trashno);
