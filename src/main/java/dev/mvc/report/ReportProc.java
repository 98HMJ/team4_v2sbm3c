...
public class ReportProc implements ReportProcInter{
  ...
  public int list_by_memberno_search_cnt(HashMap<String, Object> map) {
    int cnt = this.reportDAOInter.list_by_memberno_search_cnt(map);
    return cnt;
  }
  ...
  public ArrayList<ReportVO> list_by_memberno_serach_paging(HashMap<String, Object> map) {
     ...
     */
    int begin_of_page = ((int)map.get("now_page") - 1) * Report.RECORD_PER_PAGE;
    ...
    // 2 페이지 = 10 + 10: 20
    // 3 페이지 = 20 + 10: 30
    int end_num = begin_of_page + Report.RECORD_PER_PAGE;
    /*
    ...
    ArrayList<ReportVO> list = this.reportDAOInter.list_by_memberno_serach_paging(map);
